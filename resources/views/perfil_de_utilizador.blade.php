...
@section('content')
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="separador_dados_pessoais" data-toggle="tab" href="#dados_pessoais"
            ...
            <li class="nav-item">
                <a class="nav-link" id="separador_dados-financeiros" data-toggle="tab" href="#dados_financeiros"
